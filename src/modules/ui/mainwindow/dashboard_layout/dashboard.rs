...
pub fn view<'a>(
    ...
    let placeholder_style = |_theme: &iced::Theme| -> container::Style {
        container::Style::default()
            ...
            .border(
                border::rounded(8)
                    .color(theme::DASHBOARD_PLACEHOLDER_BORDER)
                    .width(1.5),
            )
    };
    ...
    let metrics_label: iced::widget::Column<
        '_,
        crate::modules::ui::mainwindow::application::Message,
    > = if yoy_selected {
        column![
            text("Year")
                .size(sp(18.0))
        ...
        && !chart_state.candles.is_empty()
    {
        ...
        let tools = container(drawing_tools::view(chart_state.drawing_mode.get()))
            .width(Length::Fill)
            .height(Length::Fill)
        ...
        container(
            stack![
                crate::modules::ui::splash_screen::crosshatch_background::view_with_padding(
                    1.0, 20.0
                ),
                centered_info,
            ]
